...
module.exports = function (deployer, network, accounts) {
  ...
  .then(function(instance) {
    ...
    instance.newProduct("Orange Juice", "17 oz. jug of pure-squeezed orange juice from Arizona.", web3.utils.toWei('0.010', 'ether'), 439491559042, 48, 1);
    instance.newProduct("Eggs", "Carton of eggs - 1 dozen from free-roaming chickens in Arizona.", web3.utils.toWei('0.053', 'ether'), 289946067264, 22, 1);
    ...
    instance.newProduct("Eyeshadow", "Regular eyeshadow. 12 colors. Brush not included.", web3.utils.toWei('0.077', 'ether'), 506981507612, 84, 3);
    instance.newProduct("Face Foundation", "Available in only one color at the moment - Porcelain.", web3.utils.toWei('0.073', 'ether'), 768204336115, 90, 3);
